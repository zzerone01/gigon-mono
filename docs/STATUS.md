...
3. **모바일 스토어 배포** — ✅ 코드/파이프라인 완료(2026-07-04): EAS 프로젝트
   @gigon/gigon(org 소유), 패키지 com.gigon.app, preview/production 프로필, OTA(EAS Update) 설정,
   preview APK 빌드. 앱 아이콘·스플래시 등 브랜드 에셋도 적용 완료
   (`docs/brand/assets/`). **남은 건 사용자 액션 3개** — Play Console 계정($25, 먼저 시작),
   Firebase(google-services.json + FCM 키), Android Maps 키.
   체크리스트: [docs/daily/2026-07-04.md](daily/2026-07-04.md)
