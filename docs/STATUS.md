...
0. **백엔드 API 이관** — 쓰기 RPC 15개를 SQL에서 Next.js Route Handlers(TS)로
   (오너 결정 2026-07-03). 스토어 배포(3번) 전에 완료해야 API 버저닝 부담이 없음.
   실행 스펙: [docs/service/api-migration.md](service/api-migration.md)
