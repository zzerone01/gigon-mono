...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      apply_to_gig: { Args: { p_gig: string }; Returns: string }
      audit: {
        Args: {
          p_event: string
          p_gig: string
      ...
      open_dispute: {
        Args: { p_detail?: string; p_match: string; p_reason: string }
        Returns: string
      }
      post_gig: {
        Args: {
          ...
          p_slots: number
          p_title: string
          p_type: Database["public"]["Enums"]["gig_type"]
          p_when_label: string
        }
        Returns: string
      }
      ...
      redeem_invite: {
        Args: { p_business_name?: string; p_code: string }
        Returns: boolean
      }
      report_no_show: { Args: { p_match: string }; Returns: undefined }
      ...
      verify_pin: { Args: { p_match: string; p_pin: string }; Returns: Json }
    }
    Enums: {
